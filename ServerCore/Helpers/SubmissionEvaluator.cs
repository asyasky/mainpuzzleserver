...
namespace ServerCore.Helpers
{
    ...
    public class SubmissionEvaluator
    {
        ...
        /// <returns></returns>
        public async Task<SubmissionResponse> EvaluationSubmissionAdmin(PuzzleServerContext context, PuzzleUser submittingUser, Event thisEvent, int puzzleId, string submissionText, bool allowFreeformSharing, DateTime? submissionTime)
        {
